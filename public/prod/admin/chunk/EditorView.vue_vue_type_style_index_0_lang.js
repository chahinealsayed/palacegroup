var p=(r,e,t)=>{if(!e.has(r))throw TypeError("Cannot "+t)};var h=(r,e,t)=>(p(r,e,"read from private field"),t?t.call(r):e.get(r)),g=(r,e,t)=>{if(e.has(r))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(r):e.set(r,t)},_=(r,e,t,a)=>(p(r,e,"write to private field"),a?a.call(r,t):e.set(r,t),t);import{u as j}from"./m78c574d5c3843a3d.js";import{b as O,i as k,n as m}from"./Button.js";import{c as x,d as S}from"./m6cd080c8112b9076.js";import{d as w,c as T,p as M,a as z,f as P,v as V}from"./mc55b2a42316522d6.js";import{r as B,u as $}from"./m6bdda40d8bd2cf5a.js";var c;class i{constructor(e){g(this,c,void 0);this.block=e,_(this,c,O("block"))}get id(){return`${h(this,c)}-${this.block.id}`}get classes(){return[]}}c=new WeakMap;class E extends i{render(){const{text:e,level:t,alignment:a}=this.block.data;return`
